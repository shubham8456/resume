...
\section{Summary}
  \resumeSubHeadingListStart
    \resumeSubItem{}
      {Overall 1.8+ years of experienceas as a Software Developer. Rich experience in developing applications by using Ruby.}
    \resumeSubItem{}
...
%   • Overall 3+ years of experience as a Software Developer. Kich experience in developing applications by using
% Kudy/ .NEl.
% • Currently working at Flansource India, Bangalore (Dec 2020 - F'resent).
% • Excellent understanding of Object Oriented Programming and sOLID Principles.
% • Experience using RSpec, Minitest, and Ruby Critic to improve code quality.
