...
\section{Summary}
  \begin{itemize}
    \resumeSummaryItem Overall 1.8+ years of experienceas as a Software Developer. Rich experience in web development and cloud technologies.
    ...
    \resumeSummaryItem Experience in Test driven development using RSpec/Minitest to improve code quality.
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: Ruby, Javascript, Java, Python, SQL }
      \hfill
      \textbf{Technologies}{: MVC framework, AWS, Redis, React, jQuery }
    }
  \resumeSubHeadingListEnd
